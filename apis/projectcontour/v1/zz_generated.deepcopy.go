...
func (in *HTTPInternalRedirectPolicy) DeepCopyInto(out *HTTPInternalRedirectPolicy) {
	*out = *in
	...
	if in.Predicates != nil {
		...
		*out = make([]HTTPInternalRedirectPredicate, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPInternalRedirectPredicate) DeepCopyInto(out *HTTPInternalRedirectPredicate) {
	*out = *in
	if in.AllowedRouteNames != nil {
		in, out := &in.AllowedRouteNames, &out.AllowedRouteNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPInternalRedirectPredicate.
func (in *HTTPInternalRedirectPredicate) DeepCopy() *HTTPInternalRedirectPredicate {
	if in == nil {
		return nil
	}
	out := new(HTTPInternalRedirectPredicate)
	in.DeepCopyInto(out)
	return out
}
